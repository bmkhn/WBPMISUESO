...
from .views import (
    ...
    cancel_project, undo_cancel_project, project_invoices
)
...
urlpatterns = [
    ...
    # *** FIXED: Points to the functional project_expenses view ***
    ...
    path('<int:pk>/submission/<int:submission_id>/action/', admin_submission_action, name='admin_submission_action'),
