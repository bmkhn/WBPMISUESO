    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campus', models.CharField(choices=[('MAIN', 'Main'), ('RIZAL', 'Rizal'), ('NARRA', 'Narra'), ('QUEZON', 'Quezon'), ('ARACELI', 'Araceli'), ('BROOKES_POINT', "Brooke's Point"), ('SAN_VICENTE', 'San Vicente'), ('CUYO', 'Cuyo'), ('CORON', 'Coron'), ('BALABAC', 'Balabac'), ('ROXAS', 'Roxas'), ('TAYTAY', 'Taytay'), ('EL_NIDO', 'El Nido'), ('LINAPACAN', 'Linapacan'), ('SAN_RAFAEL', 'San Rafael'), ('SOFRONIO_ESPANOLA', 'Sofronio Española'), ('DUMARAN', 'Dumaran'), ('BATARAZA', 'Bataraza')], max_length=30)),
                ('role', models.CharField(choices=[('PUBLIC', 'Public'), ('FACULTY', 'Faculty'), ('CLIENT', 'Client'), ('UESO', 'UESO'), ('COORDINATOR', 'College Coordinator'), ('DEAN', 'College Dean'), ('PROGRAM_HEAD', 'Program Head'), ('DIRECTOR', 'Director of Extension'), ('VP', 'Vice President')], default='PUBLIC', max_length=50)),
